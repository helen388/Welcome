...
nav {
    ...
    background-color: #2e9cab; /* text color used as background */
    flex-wrap: wrap;
    position: sticky;
    top: 0;
    z-index: 1000;
...
<section id="greekme">
  ...
  <div class="menu-item">
    <h3>Mixed Gyros</h3>
    <p>The ultimate gyro adventure: a little chicken, a little pork, a lot of deliciousness. Like a Greek tragedy, but everyone lives happily ever after. Served with fries, pittas, bread, and salad – because even heroes deserve balance.</p>
  </div>
...
<section id="quests">
  ...
  <div class="menu-item">
    <h3>Bifteki</h3>
    <p>Juicy Greek-style beef patties filled with herbs and maybe a secret or two from Mount Parnassus. A dish worthy of a Spartan warrior after battle. Potatoes accompany – because every epic meal needs a side quest.</p>
  </div>
...
<section id="about">
  ...
  <p>
    ...
    Welcome to Helen’s Greek Kitchen, where every dish is a journey to the heart of Greece. We pride ourselves on authentic recipes and fresh ingredients that honor the Greek culinary tradition.
  </p>
</section>
...
<section id="allergens">
  <h2>Allergens</h2>
  <p>
    Please inform our staff of any allergies. We use dairy, gluten, nuts, and seafood in our kitchen.
  </p>
</section>
...
<section id="contact">
  <h2>Contact</h2>
  <p>
    Helen's Greek Kitchen<br>
    Email: helen@helenskitchen.uk<br>
    The Three Cups Pub, Bedford<br>
